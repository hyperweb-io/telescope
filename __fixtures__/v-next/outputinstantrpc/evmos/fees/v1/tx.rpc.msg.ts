...
export interface Msg {
   ...
   */
  registerDevFeeInfo(signerAddress: string, message: MsgRegisterDevFeeInfo, fee: number | StdFee | "auto", memo?: string): Promise<any>;
  /**
   * CancelDevFeeInfo is used by a deployer to cancel a registered contract
   * and stop receiving transaction fees
   */
  cancelDevFeeInfo(signerAddress: string, message: MsgCancelDevFeeInfo, fee: number | StdFee | "auto", memo?: string): Promise<any>;
  /** UpdateDevFeeInfo is used by a deployer to update the withdraw address */
  updateDevFeeInfo(signerAddress: string, message: MsgUpdateDevFeeInfo, fee: number | StdFee | "auto", memo?: string): Promise<any>;
}
export class MsgClientImpl implements Msg {
  ...
  /* RegisterDevFeeInfo is used by a deployer to register a new contract for
   receiving transaction fees */
  registerDevFeeInfo = async (signerAddress: string, message: MsgRegisterDevFeeInfo, fee: number | StdFee | "auto" = "auto", memo: string = ""): Promise<any> => {
    const data = [{
  ...
  /* CancelDevFeeInfo is used by a deployer to cancel a registered contract
   and stop receiving transaction fees */
  cancelDevFeeInfo = async (signerAddress: string, message: MsgCancelDevFeeInfo, fee: number | StdFee | "auto" = "auto", memo: string = ""): Promise<any> => {
    const data = [{
  ...
  /* UpdateDevFeeInfo is used by a deployer to update the withdraw address */
  updateDevFeeInfo = async (signerAddress: string, message: MsgUpdateDevFeeInfo, fee: number | StdFee | "auto" = "auto", memo: string = ""): Promise<any> => {
    const data = [{
